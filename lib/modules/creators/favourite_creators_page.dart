...
class FavouriteCreatorsPage extends StatelessWidget {
  @override
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: StreamBuilder<List<CoreItemViewModel>>(
            stream: coreProvider.favouriteCreatorsBloc.coreViewItemModels,
            builder: (context, snapshot) {
              ...
              return ListView(
                  children: snapshot.data
                      .map((item) => PageCardItem<Creator>(
                            coreItemModel: item.coreItemModel, // as Creator,
